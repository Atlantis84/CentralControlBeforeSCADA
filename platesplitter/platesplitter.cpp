...
//    Q_UNUSED(event);
    ...
    {
        GDataFactory::get_udp_service()->send_message_to_plc(READ_PLC,ADDRESS_D10010,0x02,nullptr);
//        QThread::msleep(50);
//        GDataFactory::get_udp_service()->send_message_to_plc(READ_PLC,ADDRESS_D10000,0x14,nullptr);
    }
}
