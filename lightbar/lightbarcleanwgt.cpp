...
void LightBarCleanWgt::timerEvent(QTimerEvent *event)
{
    ...
    {
        GDataFactory::get_udp_service()->send_message_to_plc(READ_PLC,ADDRESS_D10040,0x04,nullptr);
    }
...
void LightBarCleanWgt::send_cmd_to_plc_accroding_to_mes_info()
{
    ...
    GDataFactory::get_udp_service()->send_message_to_plc(WRITE_PLC,ADDRESS_D10010,static_cast<short>(dataSign.length()),dataSign);
    ...
    GDataFactory::get_udp_service()->send_message_to_plc(WRITE_PLC,ADDRESS_D10011,static_cast<short>(data.length()),data);
    QTimer::singleShot(200,&eventloop,&QEventLoop::quit);
    eventloop.exec();
    ...
    GDataFactory::get_udp_service()->send_message_to_plc(WRITE_PLC,ADDRESS_D10030,0x02,finishSign);
    QTimer::singleShot(200,&eventloop,&QEventLoop::quit);
    eventloop.exec();
...
void LightBarCleanWgt::slot_btn_click()
{
    ...
    if(lgDialog.exec() == QDialog::Accepted)
    {
        ...
        clearData.append(static_cast<char>(0x00));
        clearData.append(static_cast<char>(0x00));
        GDataFactory::get_udp_service()->send_message_to_plc(WRITE_PLC,ADDRESS_D10040,0x04,clearData);
//        QThread::sleep(50);

//        QByteArray cData;
//        cData.append(static_cast<char>(0x00));
//        cData.append(static_cast<char>(0x00));
//        GDataFactory::get_udp_service()->send_message_to_plc(WRITE_PLC,ADDRESS_D10030,0x02,nullptr);
